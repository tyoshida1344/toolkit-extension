...
const Toolkit = (() => {
  ...
  const TAB_MANIFEST = [
    ...
    { id: 'color', icon: '🎨', label: 'カラー変換', scripts: ['modules/color/picker.js', 'modules/color/index.js'], styles: ['styles/color.css'] },
    ...
    { id: 'videocapture', icon: '🎥', label: '動画キャプチャ', scripts: ['modules/videocapture/time-format.js', 'modules/videocapture/index.js'], defaultHidden: true },
  ];
  ...
  function saveState(key, value, delay = SAVE_DEBOUNCE) {
